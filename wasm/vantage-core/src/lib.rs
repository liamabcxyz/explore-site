...
// Re-export the C1 wasm-bindgen surface. wasm-bindgen only walks the
// crate root for exports, so every function that needs to be callable
// from JS gets surfaced here.
