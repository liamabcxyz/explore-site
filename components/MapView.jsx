...
export default function Map({
  ...
  useEffect(() => {
    ...
    addAllLayers(map, visibleTypes).then(() => {
      // Hillshade goes in AFTER addAllLayers so it can sit at a known
      // z-order relative to the Overture layers (which have dynamic
      // IDs generated by addAllLayers). Add first, then moveLayer to
      // just under the building extrusion so hills shade under
      // buildings rather than over them. See 地形高程集成_实施方案.md §3.2.
